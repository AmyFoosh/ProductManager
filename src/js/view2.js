class View2 {
    ...
    loadFilteredList() {
        ...
        filteredList = filteredList.filter((product) => {
            ...
            if (product.code.includes(this.searchCategoryInput.value)) return product;

            // -- FILTER BY NAME --

            if (product.name.includes(this.searchCategoryInput.value)) return product;

            // -- FILTER BY PRICE --

            if (product.price.includes(this.searchCategoryInput.value)) return product;
        });
